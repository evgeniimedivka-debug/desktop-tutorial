...
Бот хранит в Cloudflare KV (`CHAT_HISTORY`) последние 50 сообщений чата
(~25 обменов) и передаёт их в Anthropic API как контекст — учитывает,
...
- [ ] Бот помнит предыдущие сообщения в рамках последних ~25 обменов.
